...
const segments: Record<string, Record<Segment, SegmentHero>> = {
  ...
  en: {
    ...
    'faktura-bez-firmy': {
      badge: 'TODO_493 freelancers already invoice through FDK · 4.7/5 on Google',
  ...
  uk: {
    ...
    'faktura-bez-firmy': {
      badge: 'TODO_493 фрилансери вже виставляють рахунки через FDK · 4.7/5 у Google',
  ...
  ru: {
    ...
    'faktura-bez-firmy': {
      badge: 'TODO_493 фрилансера уже выставляют счета через FDK · 4.7/5 в Google',
