    ...
    <section id="how-it-works" className="py-20 lg:py-28" style={{ background: SLATE_1, scrollMarginTop: '80px' }}>
      <div className="max-w-2xl mx-auto px-5 lg:px-8">
        ...
        <div className="text-center mt-10">
          <button onClick={() => scrollTo('contact')} className="inline-flex items-center gap-2 font-medium px-7 py-3 rounded-xl text-sm transition-all" style={{ border: `1.5px solid ${BLUE}`, color: BLUE, background: `${BLUE}08` }}>
            {t.howItWorks.cta}
