...
export const en: Dictionary = {
  ...
  contact: {
    heading: 'Schedule a free consultation', sub: 'Fill in the form — we reply within 1 business day.',
    fields: { name: 'First name', email: 'E-mail', phone: 'Phone (optional)', description: 'Describe your situation', descriptionPlaceholder: 'e.g. type of services, who you work for, how often you issue invoices...' },
    submit: 'Send',
