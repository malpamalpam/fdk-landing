...
export const pl: Dictionary = {
  ...
  contact: {
    ...
    sub: 'Wypełnij formularz, a nasz doradca skontaktuje się z Tobą w ciągu 24 godzin.',
    fields: { name: 'Imię', phone: 'Telefon', email: 'E-mail', services: 'Rodzaj usług i krótki opis sytuacji' },
    submit: 'Wyślij zgłoszenie',
    gdpr: 'Przesyłając formularz, akceptujesz naszą Politykę Prywatności i wyrażasz zgodę na kontakt w celu odpowiedzi na zgłoszenie.',
    success: 'Dziękujemy! Skontaktujemy się wkrótce.',
    consentCheckbox: 'Wyrażam zgodę na przetwarzanie danych osobowych w celu odpowiedzi na zapytanie.',
