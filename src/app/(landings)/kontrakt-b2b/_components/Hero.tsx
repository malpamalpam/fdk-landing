      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-8 pt-16 pb-24 lg:pt-24 lg:pb-32 flex items-center" style={{ minHeight: '88vh' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 w-full items-center">
          <div className="flex flex-col min-w-0">
            ...
            <h1 className="font-extrabold mb-6 leading-[1.1] tracking-tight" style={{ color: NAVY, fontSize: lang === 'PL' ? 'clamp(2rem, 4.2vw, 3.5rem)' : 'clamp(1.6rem, 3.4vw, 2.75rem)' }}>
              {parts.map((part, i) => (
            ...
            <div className="flex items-start gap-3 rounded-xl px-4 py-3 mb-7 w-fit max-w-sm" style={{ background: 'white', border: '1px solid rgba(37,99,235,0.13)', boxShadow: '0 1px 8px rgba(15,23,42,0.06)' }}>
              <span className="flex-shrink-0 w-[3px] self-stretch rounded-full" style={{ background: GRAD }} />
              <p className="text-[13px] leading-snug" style={{ color: MID }}>{t.hero.tagline}</p>
            </div>
          ...
          <div className="hidden lg:flex items-center justify-center relative">
            <div className="relative w-full rounded-3xl overflow-hidden" style={{ aspectRatio: '4/3', boxShadow: '0 2px 0 0 rgba(37,99,235,0.1), 0 24px 64px rgba(15,23,42,0.14), 0 8px 24px rgba(15,23,42,0.08)' }}>
              <Image src="/img/kontrakt/hero.webp" alt="Dwoje specjalistów na tarasie z panoramą Warszawy" fill className="object-cover object-center" priority sizes="(min-width: 1024px) 50vw, 100vw" />
            </div>
