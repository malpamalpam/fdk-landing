        ...
        <AccordionPrimitive.Root
          ...
          onValueChange={(val) => {
            if (val) {
              ...
              if (q) pushEvent(EVENTS.faqOpen, { landing_slug: 'landing3', question: q.slice(0, 60) });
            }
          }}
        >
          {t.faq.items.map((item, i) => (
            ...
            >
              ...
              <AccordionPrimitive.Content className="overflow-hidden data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up">
                <p className="px-6 pb-5 pt-1 text-sm leading-relaxed border-t" style={{ color: MID, borderColor: 'rgba(37,99,235,0.08)' }}>
                  {item.a}
                </p>
