...
import { SLATE_1, GRAD } from '../_lib/tokens';
import { MID } from '../_lib/tokens';
          ...
          {t.stats.map((stat, i) => (
            <div key={i} className="text-center rounded-2xl px-5 py-7 bg-white" style={{ border: '1px solid rgba(15,23,42,0.06)', boxShadow: '0 1px 6px rgba(15,23,42,0.05)' }}>
              <div
                ...
                style={{ fontSize: 'clamp(2.2rem, 4.5vw, 3.5rem)', background: GRAD, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}
              >
                {stat.value}
              </div>
